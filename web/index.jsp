    ...
    <body>
                ...
                <div class="col-lg-3 d-none d-lg-block">
                    ...
                    <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                        <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                            ...
                            <a href="" class="nav-item nav-link">Hoa tươi</a>
                            <a href="" class="nav-item nav-link">Hoa cưới</a>
                            <a href="" class="nav-item nav-link">Hoa sinh nhật</a>
                            <a href="" class="nav-item nav-link">Hoa Tết</a>
                            <a href="" class="nav-item nav-link">Hoa lễ</a>
                            <a href="" class="nav-item nav-link">Hoa lễ tốt nghiệp</a>
                            <a href="" class="nav-item nav-link">Hoa theo mùa</a>
                            <a href="" class="nav-item nav-link">Best Sellers</a>
                        </div>
                    </nav>
                </div>
                <div class="col-lg-9">
            ...
            <div class="row px-xl-5 pb-3">
                ...
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        ...
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" src="img/hoatulip.jpg" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">Hoa Tulip</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        <p class="text-right"></p>
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" src="img/hoahong.jpg" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">Hoa Hồng</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        <p class="text-right"></p>
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" src="img/hoasinhnhat.jpg" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">Hoa sinh nhật</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        <p class="text-right"></p>
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" src="img/hoacuoi.jpg" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">Hoa cưới</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
        ...
        <div class="container-fluid pt-5">
            <div class="text-center mb-4">
                <h2 class="section-title px-5"><span class="px-2">Trandy Flowers</span></h2>
            </div>
            <div class="row px-xl-5 pb-3">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/hoatulip.jpg" alt="">
                            </div>
